...
`reported_hardware_summary.csv`, and the underlying evidence is the raw ROS logs,
Leica MS60 ground-truth records, calibration log, session manifests, and
audited provenance metadata.
